...
def getCalssName(classNo):
    if   classNo == 0: return 'Stage1'
    elif classNo == 1: return 'Stage2'
    elif classNo == 2: return 'Green_apples'
    elif classNo == 3: return 'Stage3'
    elif classNo == 4: return 'Ripe'
    elif classNo == 5: return 'red_apples'
